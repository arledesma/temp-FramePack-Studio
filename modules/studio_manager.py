...
class ModelState:
    ...
    def active_model_hash(self) -> str:
        ...
        """
        return self.active_model_configuration._hash if self.active_model_configuration else "active_model_hash"
    ...
    def previous_model_hash(self) -> str:
        ...
        """
        return self.previous_model_configuration._hash if self.previous_model_configuration else "previous_model_hash"
    ...
    def update_model_state(
        ...
        assert current_generator is not None, "current_generator must be set when updating model state"
...
class StudioManager:
    ...
    def update_model_state(
        ...
        assert self.current_generator is not None, "current_generator must be set when updating model state"
